...
export const useQuestStore = create((set, get) => ({
    ...
    loading: false,
    error: null,
    initializeQuestionnaire: async (userId, questId) => {
        set({ loading: true });
        try {
    ...
    loadExistingQuestionnaire: async (userId, questId, version) => {
        set({ loading: true });
        try {
        ...
        try {
            ...
            const skills = {
                innate_strength: {
                    ...
                    description: 'What you naturally do better than most people, unprompted.',
                    natural: 4,
                    practical: 3,
                    measurable: 3,
                    total_score: 10,
    ...
    createVersion: async (userId, questId) => {
        set({ loading: true });
        try {
